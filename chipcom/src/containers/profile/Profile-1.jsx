...
class Profile extends React.Component {
  ...
  render() {
    return (
      <div>
        <div>МОЙ ПРОФИЛЬ</div>
        <dix>Lorem ipsum dolor sit amet consectetur adipisicing elit. Non laboriosam facere
           voluptatibus laborum animi ut consequatur impedit aut, quod quisquam sit inventore
            officia deserunt repellat perspiciatis accusantium sequi omnis. Repellat.</dix>
        <div>
